...
Feature: Download new Tabular Data Package ZIP from CKAN
  As a Data Consumer  
  I want to download a tabular datapackage.zip file representing the dataset, its resources and metadata from CKAN  
