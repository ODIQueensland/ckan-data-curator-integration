...
Feature: Upload a Tabular Data Package ZIP to CKAN
  As a Data Publisher  
  I want to upload a tabular datapackage.zip to CKAN  
  So that I can quickly share my data with data consumers  

  Scenario: Upload a valid Tabular Data Package ZIP to CKAN
  ...
  Scenario: Upload an invalid Tabular Data Package ZIP to CKAN
